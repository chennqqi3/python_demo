...
def sendmail():
    ...
    msg['To'] = formataddr(['我的kindle', mail_to])
    # msg['Subject'] = '一封慰问信'
    ...
    # 构建附件
    file1 = MIMEApplication(open('F:\download/世界上下五千年-付金柱,耿君.mobi', 'rb').read())
    file1.add_header('Content-Disposition', 'attachment', filename='世界上下五千年-付金柱,耿君.mobi')
    msg.attach(file1)
